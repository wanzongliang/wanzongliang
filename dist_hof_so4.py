...
def find_nearby_oxygens(file_path, cutoff_distance=0.338):
    ...
    for s_coord in s_coords:
        for HOF_num, HOF_coord in HOF_coords:
            distance = calculate_distance(HOF_coord, s_coord)
...
print("H atoms within 0.338 nm distance from any SO4 ion:")
