...
def find_nearby_oxygens(file_path, cutoff_distance=0.398):
    ...
    for cl_coord in cl_coords:
        for o_num, o_coord in o_coords:
            distance = calculate_distance(o_coord, cl_coord)
...
print("Oxygen atoms within 0.398 nm distance from any CL ion:")
